...
import json
from llm_vertex import generate_vertex_response, init_vertex_ai
...
async def analyze_image(
    ...
    try:
        ...
        client = init_vertex_ai(project_id="faq-tag-assistant")
...
def handle_faq(query: FAQQuery):
    ...
    response = generate_vertex_response(query.question, similar, client)
